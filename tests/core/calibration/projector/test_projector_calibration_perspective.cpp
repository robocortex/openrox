//==============================================================================
//
//    OPENROX   : File test_projector_calibration_perspective.cpp
//
...
ROX_TEST_SUITE_BEGIN(projector_calibration_perspective)
...
Rox_ErrorCode rox_matrix_equality(Rox_Array2D_Double K1, Rox_Array2D_Double K2, Rox_Double epsilon)
{
...
Rox_ErrorCode rox_transformtools_build_homography_model_to_image(Rox_Array2D_Double homography, Rox_Array2D_Double pose, Rox_Array2D_Double calibration)
{
   ...
   dh = rox_array2d_double_get_data_pointer_to_pointer(homography);
   dt = rox_array2d_double_get_data_pointer_to_pointer(pose);
   dk = rox_array2d_double_get_data_pointer_to_pointer(calibration);
...
ROX_TEST_CASE_DECLARE(rox::OpenROXTest, test_calibration_mono_perspective_process_linear)
{
    ...
    for ( Rox_Sint method = 1; method < 6; method++)
    {
        ...
        error = rox_matrix_equality(K, ret2->K, epsilon);
        ROX_TEST_CHECK_EQUAL ( error, ROX_ERROR_NONE );
...
ROX_TEST_CASE_DECLARE(rox::OpenROXTest, test_calibration_mono_perspective_process_nolinear)
{
    ...
    for ( Rox_Sint method = 1; method<6; method++)
    {
        ...
        error = rox_matrix_equality(K, ret->K, epsilon);
        ROX_TEST_CHECK_EQUAL ( error, ROX_ERROR_NONE );
