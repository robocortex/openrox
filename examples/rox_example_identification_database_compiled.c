//==============================================================================
//
//    OPENROX   : File rox_example_identification_database_compiled.c
//
//    Contents  : A simple example program for image identification 
//                from a compiled database on a server  
//
...
// Server variables
static Rox_Ident_Database_SE3 server_ident = 0;
static Rox_Database database = 0;
static Rox_Database_Features server_features = 0;
static Rox_Database_Item item = 0;
static Rox_Char *server_buffer = 0;
static Rox_Matrix camera_calibration = 0;
static Rox_MatSE3 pose = 0;

// Client variables
static Rox_Ident_Database_SE3 client_ident = 0;
static Rox_Database_Features client_features = 0;
static Rox_Char * client_buffer = 0;
static Rox_Camera camera = 0;
