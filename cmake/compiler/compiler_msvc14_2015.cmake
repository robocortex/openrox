MESSAGE(STATUS "\n_____ rox_open/cmake/compiler_msvc14_2015.cmake ____________________________________________\n" )

# MSVC14_2015 Configuration
set(COMPILER "msvc14_2015")
...
# Debug flags
list(APPEND ${PROJECT_NAME}_LOCAL_CMAKE_C_FLAGS_DEBUG "/DDEBUG" "/MP2")

# Optimize for current platform, remove some warnings
list(APPEND ${PROJECT_NAME}_LOCAL_CMAKE_C_FLAGS "/D_CRT_SECURE_NO_WARNINGS" "/MP2")
