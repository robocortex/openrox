//==============================================================================
//
//    OPENROX   : File linsys_tutvsr_light_affine_texture_model2d.h
//
//    Contents  : API of linsys_tutvsr_light_affine_texture_model2d module
//
...
#ifndef __OPENROX_JACOBIANTUTVSR_LA__
#define __OPENROX_JACOBIANTUTVSR_LA__
...
//! \ingroup Jacobians
//! \defgroup tutvsrjacobians tutvsrjacobians

//! \addtogroup tutvsrjacobians
//! @{

//! Compute the jacobian for image wrt tutvsr,alpha,beta
...
//! \param  [in ]  diffs          The error image
...
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_jacobian_tutvsr_light_affine_premul (
   Rox_Matrix LtL, 
   Rox_Matrix Lte, 
