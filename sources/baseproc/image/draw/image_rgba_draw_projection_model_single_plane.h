//==============================================================================
//
//    OPENROX   : File rox_image_rgba_draw_projection_model_single_plane.h
//
...
#ifndef __OPENROX_IMAGE_DISPLAY_DRAW_PROJECTION_MODEL_SINGLE_PLANE__
#define __OPENROX_IMAGE_DISPLAY_DRAW_PROJECTION_MODEL_SINGLE_PLANE__

#include <baseproc/image/draw/image_rgba_draw.h>
#include <core/model/model_single_plane.h>

//! Draw the projection of a single plane model on the color image
...
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_image_rgba_draw_projection_model_single_plane (
...
#endif // __OPENROX_IMAGE_DISPLAY_DRAW_PROJECTION_MODEL_SINGLE_PLANE__
