//==============================================================================
//
//    OPENROX   : File rgb_to_roxrgba.c
//
//    Contents  : Implementation of rgb_to_roxrgba module
//
...
#include "rgb_to_roxrgba.h"
#include <inout/system/errors_print.h>

Rox_ErrorCode rox_rgb_to_roxrgba ( Rox_Image_RGBA dest, const Rox_Uchar * buffer, const Rox_Sint stride )
{
