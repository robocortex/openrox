//==============================================================================
//
//    OPENROX   : File bgra_to_roxgray.c
//
...
Rox_ErrorCode rox_bgra_to_roxgray (Rox_Image dest, const Rox_Uchar * buffer, const Rox_Sint stride)
{
   ...
   {
      Rox_Uchar *rd = dd[i];
      // Do we really need stride ? can be simply rs = buffer
