//==============================================================================
//
//    OPENROX   : File bgr_to_roxgray.c
//
//    Contents  : Implementation of bgr_to_roxgray module
//
...
#include "bgr_to_roxgray.h"
#include <inout/system/errors_print.h>

Rox_ErrorCode rox_bgr_to_roxgray(Rox_Image dest, const Rox_Uchar * buffer, const Rox_Sint stride)
{
