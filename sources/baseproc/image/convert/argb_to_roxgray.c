//==============================================================================
//
//    OPENROX   : File argb_to_roxgray.c
//
//    Contents  : Implementation of argb_to_roxgray module
//
...
#include "argb_to_roxgray.h"
#include <inout/system/errors_print.h>

Rox_ErrorCode rox_argb_to_roxgray(Rox_Image dest, const Rox_Uchar * buffer, const Rox_Sint stride)
{
