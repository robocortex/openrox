//==============================================================================
//
//    OPENROX   : File remap_bilinear_uchar_to_float.h
//
...
#ifndef __OPENROX_REMAP_BILINEAR_UCHAR_TO_FLOAT__
#define __OPENROX_REMAP_BILINEAR_UCHAR_TO_FLOAT__
...
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_remap_bilinear_uchar_to_float (
   Rox_Array2D_Float output, 
   Rox_Imask output_mask_output, 
   const Rox_Imask output_mask_input, 
