//==============================================================================
//
//    OPENROX   : File ansi_remap_bilinear_float_to_float.c
//
//    Contents  : Implementation of ansi remap_bilinear_float_to_float module
//
...
)
{
   ...
   for ( int i = 0; i < rows_out; i++ )
   {
      for ( int j = 0; j < cols_out; j++ )
      {
         ...
         if ( !imask_ini_data[i][j] ) continue;
