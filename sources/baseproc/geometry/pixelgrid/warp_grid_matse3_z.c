//==============================================================================
//
//    OPENROX   : File warp_grid_matse3_z.c
//
...
Rox_ErrorCode rox_warp_grid_float_matse3_z_float (
   Rox_MeshGrid2D_Float grid_warp, 
   Rox_Imask grid_mask, 
   const Rox_Array2D_Float Zr, 
...
)
{
   ...
   error = rox_array2d_float_get_size ( &rows, &cols, Zr );
   ...
   Rox_Float ** Zr_data = NULL;
   error = rox_array2d_float_get_data_pointer_to_pointer ( &Zr_data, Zr );
   ROX_ERROR_CHECK_TERMINATE ( error );
   ...
   error = rox_ansi_warp_grid_float_matse3_z_float ( grid_u_data, grid_v_data, grid_mask_data, Zr_data, rows, cols, cQr_data );
   ROX_ERROR_CHECK_TERMINATE ( error );
