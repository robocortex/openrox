//==============================================================================
//
//    OPENROX   : File huber.h
//
//    Contents  : API of huber module
//
...
#ifndef __OPENROX_HUBER__
#define __OPENROX_HUBER__
...
//! \todo To be tested
ROX_API Rox_ErrorCode rox_array2d_double_huber(Rox_Array2D_Double weights, Rox_Array2D_Double workbuffer1, Rox_Array2D_Double workbuffer2, Rox_Array2D_Double input);
...
//! \return An error code
//! \todo To be tested
ROX_API Rox_ErrorCode rox_array2d_double_huber_bounded(Rox_Array2D_Double weights, Rox_Array2D_Double workbuffer1, Rox_Array2D_Double workbuffer2, Rox_Array2D_Double input, Rox_Double sigma_minimal, Rox_Double sigma_maximal);
