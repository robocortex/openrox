//==============================================================================
//
//    OPENROX   : File odometry_multiplane_params.h
//
//    Contents  : API of odometry_multiplane_params module
//
...
#ifndef __OPENROX_ODOMETRY_MULTI_PLANE_PARAMS__
#define __OPENROX_ODOMETRY_MULTI_PLANE_PARAMS__
...
enum Rox_Odometry_Multi_Plane_UseCase
{
   //! 2D model based odometry using an affine light model and an external identification
   Rox_Odometry_Multi_Plane_UseCase_Affine_Light,

   //! 2D model based odometry using a robust light model and an external identification
   Rox_Odometry_Multi_Plane_UseCase_Robust_Light
};

//! Define the pointer of the Rox_Odometry_Multi_Plane_Params_Struct
typedef struct Rox_Odometry_Multi_Plane_Params_Struct *  Rox_Odometry_Multi_Plane_Params;

//! Create a new odometry parameters object and fill it with default values
//! \param [out] params is the newly created object
//! \return An error code
//! \todo To be tested
ROX_API Rox_ErrorCode rox_odometry_multi_plane_params_new ( 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_odometry_multi_plane_params_del ( 
   Rox_Odometry_Multi_Plane_Params * params
);
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_odometry_multi_plane_params_set_prediction_radius (
   Rox_Odometry_Multi_Plane_Params params, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_odometry_multi_plane_params_set_init_pyr (
   Rox_Odometry_Multi_Plane_Params params, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_odometry_multi_plane_params_set_stop_pyr (
   Rox_Odometry_Multi_Plane_Params params, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_odometry_multi_plane_params_set_usecase (
   Rox_Odometry_Multi_Plane_Params params, 
...
#endif // __OPENROX_ODOMETRY_MULTI_PLANE_PARAMS__
