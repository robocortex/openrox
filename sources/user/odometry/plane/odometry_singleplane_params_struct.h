//==============================================================================
//
//    OPENROX   : File odometry_singleplane_params_struct.h
//
//    Contents  : Structure of odometry_singleplane_params module
//
...
struct Rox_Odometry_Single_Plane_Params_Struct
{
   ...
   enum Rox_Odometry_Single_Plane_UseCase usecase;
};
