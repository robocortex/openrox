//==============================================================================
//
//    OPENROX   : File ident_multi_photoframe_se3.h
//
//    Contents  : API of ident_multi_photoframe_se3 module
//
...
#ifndef __OPENROX_IDENT_MULTI_PHOTOFRAME_SE3__
#define __OPENROX_IDENT_MULTI_PHOTOFRAME_SE3__
...
//! \addtogroup Identification_Multi_Photoframe
//! \brief Identification of n dependent photoframes
//! @{


//! Photoframe identifier structure pointer
typedef struct Rox_Ident_Multi_PhotoFrame_Struct * Rox_Ident_Multi_PhotoFrame_SE3;


//! Create a new object for identification of n photoframes and SE(3) pose computation
//! \param  [out]  ident_multi_photoframe_se3    The newly created identification object
...
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_new ( 
...
//! \param  [out]   ident_multi_photoframe_se3          The created identification object to delete
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_del (
   Rox_Ident_Multi_PhotoFrame_SE3 * ident_multi_photoframe_se3
);


//! Append a new photoframe model
//! \param  [out]   ident_multi_photoframe_se3    The created identification object
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_addframe (
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_add_model (
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3,
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_addframe_model ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_addframe_masked ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
//! \param  [in ]  ident_multi_photoframe_se3       The created identification object
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_getcountframes ( 
   Rox_Sint * count, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_make (
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
   const Rox_Camera camera
);

ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_compute_optimal ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
   const Rox_MatUT3 Kc 
);

ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_make_optimal (
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3,
   const Rox_Camera camera
);
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_set_orientation_method (
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_set_detection_method ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
//! \param  [out]  ident_multi_photoframe_se3             The identification object
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_set_type ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_set_segment_length_min ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_set_score_threshold ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_set_side_bounds ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
   Rox_Double side_min, 
   Rox_Double side_max 
);
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_set_area_bounds ( 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
   Rox_Double area_min, 
   Rox_Double area_max 
);
...
//! \param  [out]  cTp                            If the photoframe is identified, contains the pose between the reference photoframe and its pose in the current image
//! \param  [in ]  ident_multi_photoframe_se3            The identification object
//! \param  [in ]  id                              The sequential photoframe identification
//! \return An error code
//! \todo   To be tested and renamed to rox_ident_multi_photoframe_se3_get_pose
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_pose ( 
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_optimal_pose (
   Rox_Sint * is_identified,
   Rox_MatSE3 cTo,
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3
);
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_pose_object (
   Rox_Sint * is_identified,
   Rox_MatSE3 cTo,
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3,
   Rox_Sint id
...
//! \param  [in ]  id                            The sequential photoframe identification
//! \return An error code
//! \todo   To be tested, merge with function rox_ident_multi_photoframe_se3_get_pose
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_score (
   Rox_Double *score, 
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3, 
   const Rox_Sint id
);
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_optimal_score (
   Rox_Double *score,
   Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3
);


ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_result (
   Rox_Sint * is_identified, 
   Rox_Double * score, 
   Rox_MatSE3 pose, 
   Rox_Ident_Multi_PhotoFrame_SE3 
   ident_multi_photoframe_se3, 
   Rox_Sint id
);
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_code (
   Rox_Sint * is_decoded, 
...
// Get the best score and pose cTo
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_best_result (
   Rox_Sint * identified, 
...
ROX_API Rox_ErrorCode rox_ident_multi_photoframe_se3_get_optimal_result (
   Rox_Sint * identified,
   Rox_Double * score,
   Rox_MatSE3 cTo,
   const Rox_Ident_Multi_PhotoFrame_SE3 ident_multi_photoframe_se3
