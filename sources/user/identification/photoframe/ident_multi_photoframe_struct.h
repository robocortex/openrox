...
//! Multi_Photoframe identifier structure
struct Rox_Ident_Multi_PhotoFrame_Struct
{
   ...
   // Poses of each photoframe relative to the global object frame
   Rox_ObjSet_MatSE3 pTo;

   // The pose of the camera relative to the global object frame
   Rox_MatSE3 cTo;
