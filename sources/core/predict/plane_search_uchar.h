//==============================================================================
//
//    OPENROX   : File plane_search_uchar.h
//
...
#ifndef __OPENROX_PLANE_SEARCH_UCHAR__
#define __OPENROX_PLANE_SEARCH_UCHAR__
...
struct Rox_Plane_Search_Uchar_Struct
{
...
typedef struct Rox_Plane_Search_Uchar_Struct * Rox_Plane_Search_Uchar;
...
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_new (
...
//! \param  [in ]  plane_search      The pointer to the plane searching object
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_del(
   Rox_Plane_Search_Uchar * plane_search
);
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_set_model (
   Rox_Plane_Search_Uchar plane_search, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_set_model_warp (
   Rox_Plane_Search_Uchar plane_search, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_make (
   Rox_Plane_Search_Uchar plane_search, 
   const Rox_Image current_image, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_get_shift (
   Rox_Double * shift_u, 
   Rox_Double * shift_v, 
   Rox_Plane_Search_Uchar const plane_search
);
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_get_score (
   Rox_Double * score, 
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_get_results (
   Rox_Double * score, 
   Rox_Double * shift_u, 
   Rox_Double * shift_v, 
   const Rox_Plane_Search_Uchar plane_search
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_update_pose_translation (
   Rox_MatSE3 pose, 
...
//! \param  [in ]  calib          The right calibration matrix
//! \param  [in ]  plane_search   The plane searching object
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_update_pose_rotation (
   Rox_MatSE3 rotation, 
   const Rox_MatUT3 calib, 
   const Rox_Plane_Search_Uchar plane_search
);
...
//! \return An error code
//! \todo   To be tested
ROX_API Rox_ErrorCode rox_plane_search_uchar_update_homography (
