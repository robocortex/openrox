//==============================================================================
//
//    OPENROX   : File tracking_point.h
//
//    Contents  : API of tracking_point module
//
...
#ifndef __OPENROX_TRACKING_POINT__
#define __OPENROX_TRACKING_POINT__
...
typedef struct Rox_Tracking_Point_Struct * Rox_Tracking_Point;

//! Create tracking point object
//! \param obj the pointer to the tracking object
//! \param size the patch size (a square);
//! \return An error code 
ROX_API Rox_ErrorCode rox_tracking_point_new(Rox_Tracking_Point * obj, Rox_Uint size);

//! Delete tracking point object
//! \param obj the pointer to the tracking object
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_del(Rox_Tracking_Point * obj);
...
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_set_warped_reference(
...
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_set_reference(Rox_Tracking_Point obj, Rox_Image source, Rox_Double pos_u, Rox_Double pos_v);

//! Set reference patch for point
//! \param obj the tracking object
//! \param source the reference image to use
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_set_referencepatch(Rox_Tracking_Point obj, Rox_Array2D_Float source);
...
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_set_predicted_position(Rox_Tracking_Point obj, Rox_Double pos_x, Rox_Double pos_y);
...
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_track(Rox_Tracking_Point obj, Rox_Image current, Rox_Double minscore);
...
//! \param minscore the minimum score zncc after minimization
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_track_9x9(Rox_Tracking_Point obj, Rox_Image current, Rox_Double minscore);
...
//! \param obj the tracking object
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_get_current(Rox_Double * current_x, Rox_Double * current_y, Rox_Tracking_Point obj);

//! Get a copy of the reference patch
//! \param ref the reference patch to set
//! \param obj the tracking point object
//! \return An error code
ROX_API Rox_ErrorCode rox_tracking_point_get_reference_patch(Rox_Image ref, Rox_Tracking_Point obj);

//! @} 

#endif // __OPENROX_TRACKING_POINT_OBJECT__
