//==============================================================================
//
//    OPENROX   : File tracking_point_11x11.c
//
//    Contents  : Implementation of tracking_point_11x11 module
//
...
#include "tracking_point_11x11.h"
...
#include <float.h>
   ...
   //! To be commented
struct Rox_Tracking_Point_11x11_Struct
{
   //! To be commented
   Rox_Double pos_x;
   //! To be commented
...
Rox_ErrorCode rox_tracking_point_11x11_new(Rox_Tracking_Point_11x11 * obj)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
   Rox_Tracking_Point_11x11 ret = NULL;
   Rox_Uint bigsize, size = 11;
   ...
   *obj = NULL;
   ...
   ret = (Rox_Tracking_Point_11x11) rox_memory_allocate(sizeof(*ret), 1);
   if (!ret)
   ...
   if (error)
   {
      rox_tracking_point_11x11_del(&ret);
      {error = ROX_ERROR_NULL_POINTER; ROX_ERROR_CHECK_TERMINATE ( error );}
   }
...
function_terminate:
   if (error) rox_tracking_point_11x11_del(&ret);
   return ROX_ERROR_NONE;
}

Rox_ErrorCode rox_tracking_point_11x11_del(Rox_Tracking_Point_11x11 * obj)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
   Rox_Tracking_Point_11x11 todel = NULL;
...
Rox_ErrorCode rox_tracking_point_11x11_set_reference(Rox_Tracking_Point_11x11 obj, Rox_Image source, Rox_Double pos_x, Rox_Double pos_y)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
...
Rox_ErrorCode rox_tracking_point_11x11_set_warped_reference(Rox_Tracking_Point_11x11 obj, Rox_Image source, Rox_Double pos_u, Rox_Double pos_v, Rox_Double Z, Rox_Array2D_Double pose, Rox_Array2D_Double calibration_ref, Rox_Array2D_Double calibration_cur)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
...
Rox_ErrorCode rox_tracking_point_11x11_set_referencepatch(Rox_Tracking_Point_11x11 obj, Rox_Array2D_Float source)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
...
Rox_ErrorCode rox_tracking_point_11x11_set_predicted_position(Rox_Tracking_Point_11x11 obj, Rox_Double pos_x, Rox_Double pos_y)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
...
Rox_ErrorCode rox_tracking_point_11x11_get_current(Rox_Double * current_x, Rox_Double * current_y, Rox_Tracking_Point_11x11 obj)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
...
Rox_ErrorCode rox_tracking_point_11x11_get_reference_patch(Rox_Image ref, Rox_Tracking_Point_11x11 obj)
{
   Rox_ErrorCode error = ROX_ERROR_NONE;
...
Rox_ErrorCode rox_tracking_point_11x11_track(Rox_Tracking_Point_11x11 obj, Rox_Image current, Rox_Double minscore)
{
   Rox_Uint iter;
   Rox_ErrorCode error = ROX_ERROR_NONE;
   ...
   for (iter = 0; iter < 8; iter++)
   {
      ...
      if (itx + 13 >= swidth - 1 || ity + 13 >= sheight - 1)
      { error = ROX_ERROR_NUMERICAL_ALGORITHM_FAILURE; ROX_ERROR_CHECK_TERMINATE ( error ); }
...
Rox_ErrorCode rox_tracking_point_11x11_track_x(Rox_Tracking_Point_11x11 obj, Rox_Image current, Rox_Double minscore)
{
   Rox_Uint iter;
   Rox_ErrorCode error = ROX_ERROR_NONE;
   Rox_Double ** dsol, **djtj, *djtf, zncc;
